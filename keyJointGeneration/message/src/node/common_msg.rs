...
use crate::node::keygen_msg::{NodeKeyGenPhaseOneBroadcastMsg, NodeToProxyKeyGenPhaseTwoP2PMsg, NodeToProxyKeyGenPhaseFourP2PMsg};
...
pub enum KeyGenMsg {
    ...
    NodeToProxyKeyGenPhaseFourP2PMsg(NodeToProxyKeyGenPhaseFourP2PMsg),
}
